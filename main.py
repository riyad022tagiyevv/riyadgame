...
if hex(getnode()) in ["0xdc7b23bb434e"]: #windows masaüstü pc ise veya laptop
    ...
    print("kyb")
    bot_adi = "SozBetaBot"
    bot_token = "6183371678:AAHnZ6D0rnzCJufHUSFxkmjl9Veco4uHsgk"
...
kurucu_id = 5809546648

admins = [kurucu_id, 5809546648]
...
async def sessiz_sinema_baslat(message, **kwargs): 
    ...
    if user_id in admins and user_id != 5809546648 and user_id != 5809546648:
        ayir = text.split("\n")
        for a in range(len(ayir)):
            if first_name in ayir[a]:
